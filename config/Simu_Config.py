...
class SimuConfig(object):
    ...
    def save_embedding_matrix(self, best_model, best_model1):
        ...
        path1 = os.path.join(self.result_dir, self.RecomModel.__name__ + '-div.json')
    ...
    def test(self):
        if self.test_recom:
            ...
            if os.path.exists(os.path.join(self.result_dir,  self.RecomModel.__name__ + "-div.json")):
                os.rename(os.path.join(self.result_dir,  self.RecomModel.__name__ + "-div.json"),
                os.path.join(self.result_dir,'div_{}_{}_{}_{}_{}_{}_{}.json'.format(self.RecomModel.__name__,
                self.margin, self.hidden_size,self.batch_size, self.bern, self.alpha,self.weight_decay)))
